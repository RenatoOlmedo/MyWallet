...
export const ModalBalace = ({ onClose, open, userId }) => {
    ...
    var total =  (parseFloat(newBalance.balance + (newBalance.investments.reduce((accumulator, current) => accumulator + current.result,0))))
    if (isNaN(total)) {
        console.log('total é NaN');
        total = 0; // Se for NaN, define total como 0
    }
    return (
        <>
                            ...
                            <form onSubmit={CriaInvestment}>
                                ...
                                <div className="input-group">
                                    ...
                                    <input
                                        ...
                                        id={`balanceOperation`}
                                        required
                                        value={isNaN(newBalance.balance) ? 0 : newBalance.balance}
                                        onChange={(e) => {
                                            ...
                                            <div key={index} className="col-md-6 col-12">
                                                ...
                                                <div className="input-group">
                                                    ...
                                                    <input
                                                        ...
                                                        required
                                                        value={isNaN(newBalance.investments[index].result) ? 0 : newBalance.investments[index].result}
                                                        onChange={(e) => {
                                                            setNewBalance({
                                                                ...newBalance,
                                                                investments: newBalance.investments.map((item, idx) =>
                                ...
                                <div className="col-6 mt-5">
                                    ...
                                    <span class="input-group-text">R$</span>
                                    <input className="form-control" type="text" disabled value={total}></input>
